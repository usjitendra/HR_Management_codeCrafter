...
app.use(cors({
  origin: ["http://localhost:5173","http://localhost:3000","https://hrms112.netlify.app","updatehrma.netlify.app","https://dr-monika.netlify.app"], 
  origin: ["http://localhost:5173","http://localhost:3000","https://hrms112.netlify.app","updatehrma.netlify.app","http://localhost:5174","sadbhawanaclinic.com","https://www.sadbhawanaclinic.com/", "https://sadbhawanaclinic.com/"], 
  credentials: true,
}));
...
const io=new Server(server,{
       cors:{
        origin:["http://localhost:5173","http://localhost:3000","https://hrms112.netlify.app","updatehrma.netlify.app"],
        credentials: true,
       }
})
