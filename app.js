...
app.use(
  cors({
    origin: [
      'http://localhost:5173',
      'http://localhost:3000',
      'https://hrms112.netlify.app',
      'https://updatehrmsa.netlify.app',
      'https://dr-monika.netlify.app',
      'https://updatehrmsa111.netlify.app',
    ],
    origin: [
      'http://localhost:5173',
      'http://localhost:3000',
      ...
      'http://localhost:5174',
      'https://updatehrmsa111.netlify.app',
      'sadbhawanaclinic.com',
      'https://www.sadbhawanaclinic.com/',
      'https://sadbhawanaclinic.com/',
    ],
    credentials: true,
  })
);
